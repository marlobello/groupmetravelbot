...
**Stack**: Python 3.14 · FastAPI · [Microsoft Agent Framework](https://learn.microsoft.com/en-us/agent-framework/overview/) · Microsoft Foundry Agent Service (gpt-4.1) with hosted Web Search · Azure Blob Storage · Azure Container Apps · Managed Identity
